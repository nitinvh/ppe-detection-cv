...
def generate_detections(encoder, mot_dir, output_dir, detection_dir=None):
    ...
    try:
        ...
        if exception.errno == errno.EEXIST and os.path.isdir(output_dir):
            ...
            raise ValueError("Failed to create output directory '%s'" % output_dir)
...
def parse_args():
    ...
    parser.add_argument("--model", default="resources/networks/mars-small128.pb", help="Path to .pb model file.")
    parser.add_argument("--mot_dir", required=True, help="Path to MOTChallenge directory (train or test)")
    parser.add_argument("--detection_dir", default=None, help="Optional path to custom detections directory.")
    parser.add_argument("--output_dir", default="detections", help="Output directory path.")
